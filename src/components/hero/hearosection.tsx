...
export default function HeroSection() {
  ...
  return (
    <div className="bg-radial-[at_50%_75%] from-[100%_0_0] via-[var(--bggradient)] to-[var(--bgbradientstart)] to-90% pt-10 flex items-center justify-center overflow-hidden min-h-[70vh]">
          ...
          >
            <div className="flex flex-col items-center">
              <Link href="/" className="flex items-center gap-2 mb-4">
                ...
                <span className="text-2xl md:text-4xl font-semibold text-text">UzbekHub</span>
              </Link>
