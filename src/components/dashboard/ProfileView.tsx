...
// import { getProfile, updateProfile, checkUsername, changeEmail, confirmEmailChange, updateLocation } from "@/lib/api"
...
//         setIsFetchingLocation(false)
//         setIsLocationPermissionOpen(false)
//         toast.error("Joylashuvni aniqlashda xato: " + error.message)
//       },
...
//               Joylashuvingizni aniqlash uchun ruxsat bering. Bu sizning hozirgi manzilingizni xaritada ko'rsatishga yordam beradi.
//             </div>
//             <DialogFooter>
...
//                 disabled={isFetchingLocation}
//               >
//                 {isFetchingLocation && <Loader2 className="w-4 h-4 mr-2 animate-spin" />}
//                 Ruxsat berish
//               </Button>
//             </DialogFooter>
//           </DialogContent>
          ...
          {!dynamicLocation ? (
            ...
            >
              ...
              <div className=" mt-4">
                <Button
                  onClick={handleGetLocation}
                  // className="relative flex-1 bg-gradient-to-r from-blue-500 via-cyan-500 to-teal-500 text-white font-semibold rounded-lg px-6 py-3 transition-all duration-300 ease-in-out shadow-md hover:shadow-xl hover:scale-105 transform"
                  disabled={isFetchingLocation}
                >
                  {isFetchingLocation ? (
                    <Loader2 className="w-5 h-5 mr-2 animate-spin" />
                ...
                <Button
                  ...
                  // className="relative flex-1 bg-gradient-to-r from-red-500 via-rose-500 to-pink-500 text-white font-semibold rounded-lg px-6 py-3 transition-all duration-300 ease-in-out shadow-md hover:shadow-xl hover:scale-105 transform"
                  disabled={isFetchingLocation}
                >
