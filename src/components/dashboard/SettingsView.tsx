                ...
                <Card className="bg-white/5 border-white/10 backdrop-blur-[10px]">
                  ...
                  <CardContent className="space-y-4">
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-text">{t("general.language")}</label>
                ...
                <Card className="bg-white/5 border-white/10 backdrop-blur-[10px]">
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="font-medium text-text">{t("general.sound.message")}</p>
                        <p className="text-sm text-gray-400">{t("general.sound.message_desc")}</p>
                      </div>
                      <Switch defaultChecked />
                    </div>
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="font-medium text-text">{t("general.sound.notification")}</p>
                        <p className="text-sm text-gray-400">{t("general.sound.notification_desc")}</p>
                      </div>
                      <Switch defaultChecked />
                    </div>
                  </CardContent>
              ...
              <TabsContent value="notifications" className="space-y-6">
                <Card className="bg-white/5 border-white/10 backdrop-blur-[10px]">
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="font-medium text-text">{t("notifications.message")}</p>
                        <p className="text-sm text-gray-400">{t("notifications.message_desc")}</p>
                      </div>
                      <Switch
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="font-medium text-text">{t("notifications.group")}</p>
                        <p className="text-sm text-gray-400">{t("notifications.group_desc")}</p>
                      </div>
                      <Switch
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="font-medium text-text">{t("notifications.donation")}</p>
                        <p className="text-sm text-gray-400">{t("notifications.donation_desc")}</p>
                      </div>
                      <Switch
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="font-medium text-text">{t("notifications.mention")}</p>
                        <p className="text-sm text-gray-400">{t("notifications.mention_desc")}</p>
                      </div>
                      <Switch
              ...
              <TabsContent value="privacy" className="space-y-6">
                <Card className="bg-white/5 border-white/10 backdrop-blur-[10px]">
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="font-medium text-text">{t("privacy.show_online")}</p>
                        <p className="text-sm text-gray-400">{t("privacy.show_online_desc")}</p>
                      </div>
                      <Switch
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="font-medium text-text">{t("privacy.show_location")}</p>
                        <p className="text-sm text-gray-400">{t("privacy.show_location_desc")}</p>
                      </div>
                      <Switch
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="font-medium text-text">{t("privacy.allow_donations")}</p>
                        <p className="text-sm text-gray-400">{t("privacy.allow_donations_desc")}</p>
                      </div>
                      <Switch
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-text">{t("privacy.profile_visibility.title")}</label>
                      <Select
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value="public">{t("privacy.profile_visibility.public")}</SelectItem>
                          <SelectItem value="friends">{t("privacy.profile_visibility.friends")}</SelectItem>
                          <SelectItem value="private">{t("privacy.profile_visibility.private")}</SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
                  </CardContent>
                ...
                <Card className="bg-white/5 border-white/10 backdrop-blur-[10px]">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="pt-4 border-t border-white/10">
                      <h3 className="font-medium text-text mb-3">{t("security.active_sessions")}</h3>
                      <div className="space-y-3">
                        <div className="flex items-center justify-between p-3 bg-white/5 rounded-lg border border-white/10">
                          <div>
                            <p className="font-medium text-text">Current </p>
